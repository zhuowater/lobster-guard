...
(蓝信/飞书/钉钉/企微) │  │    │                                              │  │
                    ...
                    │  │  ┌──────────────────────────────────────┐         │  │
                    │  │  │ 入站检测链(8层并行)                    │         │  │
                    │  │  │ L1 AC自动机 ──→ L2 正则 ──→ L3 语义  │         │  │
                    │  │  │ L4 行业模板(40×12) ──→ L5 Auto-Review│         │  │
                    │  │  │ L6 奇点蜜罐 ──→ L7 PII标记           │         │  │
                    │  │  │ L8 信封签名 ──→ 事件发射              │         │  │
                    │  │  └──────────┬───────────────────────────┘         │  │
                    │  │             ▼                                      │  │
                    │  │  路由表(亲和绑定) ──→ 上游容器池 ──────────────────────► OpenClaw ×N
                    │  │                                                    │  │
OpenClaw 出站 ─────────►  :18444 出站代理                                    │  │
                    │  │    │                                              │  │
                    │  │    ▼                                              │  │
                    │  │  出站规则(PII/凭据/命令) ──→ 污染追踪 ──→ 逆转 ─────────► 消息平台 API
                    │  │                                                    │  │
                    │  └────────────────────────────────────────────────────┘  │
                    │                                                          │
                    │  ┌──────── LLM 安全域 ────────────────────────────────┐  │
                    │  │                                                    │  │
Agent/应用 ────────────►  :8445 LLM 反向代理                                │  │
                    │  │    │                                              │  │
                    │  │    ▼                                              │  │
                    │  │  ┌──────────────────────────────────────┐         │  │
                    │  │  │ LLM 检测链(12层)                      │         │  │
                    ...
                    │  │  └──────────┬───────────────────────────┘         │  │
                    │  │             ▼                                      │  │
                    │  │  SSE streaming ──→ 上游 LLM API ────────────────────► DeepSeek/GLM/Qwen
                    │  │                                                    │  │
                    │  └────────────────────────────────────────────────────┘  │
                    │                                                          │
                    │  ┌──────── 管理层 ────────────────────────────────────┐  │
                    │  │                                                    │  │
运维/安全团队 ─────────►  :9090 Dashboard + API (487路由)                     │  │
                    │  │    │                                              │  │
                    │  │    ├── Vue 3 Dashboard (50页面/75组件)             │  │
                    │  │    ├── SQLite WAL (67表, 批量写入)                 │  │
                    │  │    ├── WSS RPC → Gateway 远程管理                  │  │
                    │  │    ├── 安全画像(5维×16引擎)                        │  │
                    │  │    └── 多租户 · 会话回放 · 报告 · 红队              │  │
                    │  │                                                    │  │
                    │  └────────────────────────────────────────────────────┘  │
