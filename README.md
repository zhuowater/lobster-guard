...
<p align="center">
  <img src="https://img.shields.io/badge/version-3.10.0-00d4ff?style=flat-square" alt="Version">
...
```
lobster-guard/
├── main.go                 # 全部源码（~6602 行，含 5 通道插件 + Bridge + Rate Limit + Metrics + 多Bot亲和路由）
