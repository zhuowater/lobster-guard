...
const TABS = {
  ...
  policy: {
    ...
    icon: 'settings',
    groups: [
      { label: 'IM 策略', routes: ['rules', 'inbound-templates', 'routes', 'upstream'] },
      { label: 'LLM 策略', routes: ['llm-rules', 'llm-templates', 'llm-targets', 'tools', 'cache', 'gateway', 'plan-compiler', 'agent', 'ab-testing'] },
