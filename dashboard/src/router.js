...
const routes = [
  ...
  { path: '/gateway-sessions', name: 'gateway-sessions', component: () => import('./views/GatewaySession.vue'), meta: { title: '会话管理', icon: 'message-square', group: 'system' } },
  { path: '/gateway-cron', name: 'gateway-cron', component: () => import('./views/GatewayCron.vue'), meta: { title: '定时任务', icon: 'clock', group: 'system' } },
  { path: '/gateway-agents', name: 'gateway-agents', component: () => import('./views/GatewayAgentFiles.vue'), meta: { title: 'Agent 管理', icon: 'bot', group: 'system' } },
