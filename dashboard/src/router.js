...
const routes = [
  ...
  { path: '/security-overview', redirect: '/behavior' },
  ...
  { path: '/agent', name: 'agent', component: () => import('./views/AgentBehavior.vue'), meta: { title: '工具行为审计', icon: 'bot', group: 'llm' } },
  { path: '/agent-profiles', name: 'agent-profiles', component: () => import('./views/BehaviorProfile.vue'), meta: { title: 'Agent 画像', icon: 'behavior', group: 'llm' } },
  { path: '/behavior', name: 'behavior', component: () => import('./views/SecurityOverview.vue'), meta: { title: '安全画像', icon: 'shield', group: 'threat' } },
  ...
  { path: '/source-classifier', name: 'source-classifier', component: () => import('./views/SourceClassifier.vue'), meta: { title: '来源分类', icon: 'globe', group: 'govern' } },
  ...
  // inbound-templates and llm-templates routes removed - integrated into Rules.vue and LLMRules.vue
