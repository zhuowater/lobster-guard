...
const routes = [
  ...
  { path: '/custom', name: 'custom-dashboard', component: () => import('./views/CustomDashboard.vue'), meta: { title: '自定义大屏', icon: '🎨', group: 'im' } },
  ...
  { path: '/behavior', name: 'behavior', component: () => import('./views/BehaviorProfile.vue'), meta: { title: '行为画像', icon: '🧠', group: 'llm' } },
  ...
  { path: '/honeypot', name: 'honeypot', component: () => import('./views/Honeypot.vue'), meta: { title: 'Agent 蜜罐', icon: '🍯', group: 'llm' } },
  { path: '/attack-chains', name: 'attack-chains', component: () => import('./views/AttackChain.vue'), meta: { title: '攻击链分析', icon: '🔗', group: 'llm' } },
  ...
  { path: '/leaderboard', name: 'leaderboard', component: () => import('./views/Leaderboard.vue'), meta: { title: '排行榜', icon: '🏆', group: 'system' } },
