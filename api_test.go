...
func setupMgmtAPI(t *testing.T) (*ManagementAPI, func()) {
	...
	api := NewManagementAPI(cfg, "", pool, routes, logger, engine, outEngine, inbound, nil, nil, nil, nil, nil, nil, nil, nil, nil)
...
func TestAPIRuleHitsWithGroup(t *testing.T) {
	...
	api := NewManagementAPI(cfg, "", pool, routes, logger, engine, outEngine, inbound, nil, nil, ruleHits, nil, nil, nil, nil, nil, nil)
