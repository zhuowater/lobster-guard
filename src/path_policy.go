...
var defaultPathPolicies = []PathPolicyRule{
	...
	{ID: "pp-019", Name: "metadata_service_then_send_email", RuleType: "sequence",
		Conditions: `{"after":"source:metadata_service","before":"send_email","window_sec":300}`,
		Action: "block", Enabled: true, Priority: 5, TenantID: "default",
		Description: "命中元数据服务后5分钟内禁止发送邮件，防云凭据外泄"},
	{ID: "pp-020", Name: "metadata_service_then_shell", RuleType: "sequence",
		Conditions: `{"after":"source:metadata_service","before":"shell_exec","window_sec":300}`,
		Action: "block", Enabled: true, Priority: 5, TenantID: "default",
		Description: "命中元数据服务后5分钟内禁止执行Shell，防凭据利用扩散"},
	{ID: "pp-021", Name: "internal_api_then_send_email", RuleType: "sequence",
		Conditions: `{"after":"source:internal_api","before":"send_email","window_sec":300}`,
		Action: "warn", Enabled: true, Priority: 12, TenantID: "default",
		Description: "访问内部API后5分钟内发邮件时告警，防内部数据外发"},
	{ID: "pp-022", Name: "external_api_auth_then_file_write", RuleType: "sequence",
		Conditions: `{"after":"source:external_api","before":"file_write","window_sec":180}`,
		Action: "warn", Enabled: true, Priority: 15, TenantID: "default",
		Description: "调用外部认证API后短时间写文件时告警，提示检查落盘内容来源"},
	{ID: "pp-023", Name: "public_web_then_shell", RuleType: "sequence",
		Conditions: `{"after":"source:public_web","before":"shell_exec","window_sec":120}`,
		Action: "block", Enabled: true, Priority: 8, TenantID: "default",
		Description: "读取公开网页后2分钟内禁止执行Shell，防网页指令注入"},
}
