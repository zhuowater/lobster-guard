...
func TestMetricsEndpoint(t *testing.T) {
	...
	api := NewManagementAPI(cfg, "", pool, routes, logger, engine, outEngine, inbound, gp, metrics, nil, nil, nil, nil)
...
func TestMetricsEndpoint_Disabled(t *testing.T) {
	...
	engine := NewRuleEngine()
	inbound := NewInboundProxy(cfg, gp, engine, logger, pool, routes, nil, nil, nil, nil)
	api := NewManagementAPI(cfg, "", pool, routes, logger, engine, outEngine, inbound, gp, nil, nil, nil, nil, nil) // metrics=nil
...
func createTestManagementAPIWithEngine(t *testing.T) (*ManagementAPI, *RuleEngine, func()) {
	...
	channel := NewGenericPlugin("", "")
	inbound := NewInboundProxy(cfg, channel, engine, logger, pool, routes, nil, nil, nil, nil)
	api := NewManagementAPI(cfg, "", pool, routes, logger, engine, outEngine, inbound, channel, nil, nil, nil, nil, nil)
	cleanup := func() { logger.Close(); db.Close(); os.Remove(tmpDB) }
...
`
	...
	channel := NewGenericPlugin("", "")
	inbound := NewInboundProxy(cfg, channel, engine, logger, pool, routes, nil, nil, nil, nil)
	api := NewManagementAPI(cfg, tmpCfg.Name(), pool, routes, logger, engine, outEngine, inbound, channel, nil, nil, nil, nil, nil)
...
func TestRuleHitStats_API(t *testing.T) {
	...
	api := NewManagementAPI(cfg, "", pool, routes, logger, engine, outEngine, inbound, channel, nil, ruleHits, nil, nil, nil)
