...
func TestMetricsCollector_WritePrometheus(t *testing.T) {
	...
	checks := []string{
		...
		`lobster_guard_info{version="4.0.0",channel="lanxin",mode="webhook"} 1`,
	}
...
func TestMetricsCollector_WritePrometheus_WithBridge(t *testing.T) {
	...
	if !strings.Contains(output, `lobster_guard_info{version="4.0.0",channel="feishu",mode="bridge"} 1`) {
...
func TestMetricsEndpoint(t *testing.T) {
	...
	api := NewManagementAPI(cfg, "", pool, routes, logger, engine, outEngine, inbound, gp, metrics, nil, nil, nil, nil, nil)
...
func TestMetricsEndpoint_Disabled(t *testing.T) {
	...
	api := NewManagementAPI(cfg, "", pool, routes, logger, engine, outEngine, inbound, gp, nil, nil, nil, nil, nil, nil) // metrics=nil
