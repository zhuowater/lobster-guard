...
func TestMetricsCollector_WritePrometheus(t *testing.T) {
	...
	checks := []string{
		...
		`lobster_guard_info{version="3.11.0",channel="lanxin",mode="webhook"} 1`,
	}
...
func TestMetricsCollector_WritePrometheus_WithBridge(t *testing.T) {
	...
	if !strings.Contains(output, `lobster_guard_info{version="3.11.0",channel="feishu",mode="bridge"} 1`) {
