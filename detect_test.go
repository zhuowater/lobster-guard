...
func createTestManagementAPIWithEngine(t *testing.T) (*ManagementAPI, *RuleEngine, func()) {
	...
	api := NewManagementAPI(cfg, "", pool, routes, logger, engine, outEngine, inbound, channel, nil, nil, nil, nil, nil, nil)
...
`
	...
	channel := NewGenericPlugin("", "")
	inbound := NewInboundProxy(cfg, channel, engine, logger, pool, routes, nil, nil, nil, nil)
	api := NewManagementAPI(cfg, tmpCfg.Name(), pool, routes, logger, engine, outEngine, inbound, channel, nil, nil, nil, nil, nil, nil)
...
func TestRuleHitStats_API(t *testing.T) {
	...
	api := NewManagementAPI(cfg, "", pool, routes, logger, engine, outEngine, inbound, channel, nil, ruleHits, nil, nil, nil, nil)
